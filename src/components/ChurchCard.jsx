...
export default function ChurchCard({ church, isVisited, onClick, onViewOnMap }) {
    ...
    return (
        <div
            className="church-select-item rounded-2xl p-4 border border-gray-100 transition-all cursor-pointer relative overflow-hidden group shadow-sm hover:border-blue-200 bg-white"
            onClick={onClick}
        >
