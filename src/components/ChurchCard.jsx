...
export default function ChurchCard({ church, isVisited, onClick, onViewOnMap }) {
    ...
    return (
        <div
            className="church-select-item rounded-2xl p-4 border border-blue-50 transition-all cursor-pointer relative overflow-hidden group shadow-sm hover:shadow-md hover:border-blue-200 active:scale-[0.98] bg-white"
            onClick={onClick}
        >
