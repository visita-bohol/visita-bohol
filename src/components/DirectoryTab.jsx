                        ...
                        >
                            {currentMonthChurches.map(church => {
                                ...
                                return (
                                    <div
                                        key={church.id}
                                        className="fiesta-card-horizontal rounded-2xl p-4 border border-gray-100 shadow-sm transition-all hover:border-blue-600 hover:bg-blue-50/10 hover:shadow-md hover:shadow-blue-100 active:border-blue-600 active:bg-blue-50/10 relative overflow-hidden flex-shrink-0 snap-start"
