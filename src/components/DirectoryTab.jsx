                        ...
                        >
                            {currentMonthChurches.map(church => {
                                ...
                                return (
                                    <div
                                        key={church.id}
                                        className="fiesta-card-horizontal rounded-2xl p-4 border border-white transition-all cursor-pointer relative overflow-hidden group shadow-sm hover:shadow-md hover:border-blue-600 active:border-blue-600 active:scale-[0.98] flex-shrink-0 snap-start"
