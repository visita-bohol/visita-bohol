                                        ...
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="pt-2 border-t border-gray-100/50 flex items-center justify-between">
                                                    ...
                                                    <div className="bg-white/80 text-gray-400 px-2 py-1 rounded-full text-[9px] font-bold flex items-center gap-1 border border-gray-100/50 group-hover:bg-blue-50 group-hover:text-blue-600 group-hover:border-blue-100 transition-colors">
