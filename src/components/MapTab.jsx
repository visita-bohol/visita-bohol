            ...
            <div className="absolute bottom-6 right-4 z-[400] flex flex-col gap-2 items-end pointer-events-none">
                ...
                <button
                    ...
                    className={`h-12 w-12 rounded-xl shadow-lg border transition-all pointer-events-auto ${(isAddMode || tempCoordinate)
                        ...
                        : 'text-orange-500 !bg-white border-blue-100 hover:border-orange-500 hover:bg-orange-50/10 hover:shadow-md hover:shadow-orange-100 active:scale-95 shadow-sm'}`}
